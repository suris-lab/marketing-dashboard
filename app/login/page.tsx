  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-950">
      <div className="w-full max-w-sm rounded-2xl border border-gray-800 bg-gray-900 p-8 text-center shadow-xl">
        <p className="mb-1 text-xs font-bold uppercase tracking-widest text-blue-400">HHYC</p>
        <h1 className="mb-1 text-xl font-semibold text-white">Marketing Dashboard</h1>
        <p className="mb-8 text-sm text-gray-500">Sign in to access your analytics</p>
